...
class Goal():
    ...
    def draw(self, screen, ball):
        ...
        screen.blit(pygame.transform.flip(self.back, flip_x=True, flip_y=False), (-14, HEIGHT - 445))
        ball.draw(screen)
        screen.blit(self.front, (WIDTH - 110, HEIGHT - 445))
        screen.blit(pygame.transform.flip(self.front, flip_x=True, flip_y=False), (-59, HEIGHT - 445))